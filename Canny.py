...
def double_threshold(non_maximum_suppression_img, low_threshold_ratio, high_threshold_ratio):
    ...
    weak_i, weak_j = np.where((non_maximum_suppression_img >= low_threshold)
                              & (non_maximum_suppression_img < high_threshold))

    double_threshold_img[strong_i, strong_j] = 255
    double_threshold_img[weak_i, weak_j] = non_maximum_suppression_img[weak_i, weak_j]
